...
namespace PeopleGen.Dal
{
    public class PeopleDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //{
            //    new Person() { PersonId = 1, FirstName = "Talice", LastName = "Nenna", Age = 46, SpeciesName="Elf", Gender="Female",Strength = 10,Dexterity = 14, Constitution = 10, Intelligence = 15, Wisdom = 18, Charisma = 18, Alignment = PeopleGen.Core.enums.Moral.Neutral +" "+  PeopleGen.Core.enums.Alignment.Neutral},

            //    new Person() { PersonId = 2, FirstName = "Narook", LastName = "Vunakian", Age = 20, SpeciesName="Goliath", Gender="Male", Strength = 20,Dexterity = 13, Constitution = 116, Intelligence = 11, Wisdom = 11, Charisma = 12, Alignment = PeopleGen.Core.enums.Moral.Chaotic +" "+  PeopleGen.Core.enums.Alignment.Neutral },

            //    new Person() { PersonId = 3, FirstName = "Denede", LastName = "FireStarter", Age = 30, SpeciesName="Elf", Gender="Male", Strength = 10,Dexterity = 19, Constitution = 19, Intelligence = 18, Wisdom = 15, Charisma = 13, Alignment = PeopleGen.Core.enums.Moral.Chaotic +" "+  PeopleGen.Core.enums.Alignment.Neutral }
